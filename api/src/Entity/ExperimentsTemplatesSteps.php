...
/**
 * ExperimentsTemplatesSteps
 *
 * @ORM\Table(name="experiments_templates_steps", indexes={@ORM\Index(name="fk_experiments_templates_steps_items_id", columns={"item_id"})})
 * @ApiResource
 * @ORM\Entity
 */
class ExperimentsTemplatesSteps
{
    /**
     * @var int
     *
